...
public class Test {
	public static void main(String[] args) throws Exception {
		...
		try (var reader = new CatalogueReader("D:\\copy acer\\EDUCATIONN\\Education\\HSR Unterlagen\\OPP\\Testat\\08_Vorlagen\\08_Vorlagen\\Aufgabe1\\StudyCatalogue.txt")) {
			String[] names;
