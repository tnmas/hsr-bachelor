 ...
 * Version: Tue Feb 12 18:21:33 CET 2019
 */

package uebung01.ml.aufgabe02;
...
//    }
    ...
    // Fast solution:
    int[] alfaCounts = new int['z'+1];
    for (int j = 0; j < text.length(); j++) {
      alfaCounts[text.charAt(j)]++;
    }
    for (int i = 0; i < chars.length; i++) {
      charsCounts[i] = alfaCounts[chars[i]]; 
    }
